    ...
    <el-row :gutter="15">
      ...
      <el-col :span="17">
        ...
        <div style="margin-top: 20px;" v-if="data.goodsData.hasFlash || data.goodsData.hasGroup">
          <el-button type="danger" style="padding: 20px 30px;" v-if="data.goodsData.hasFlash">去秒杀</el-button>
          <el-button type="warning" style="padding: 20px 30px;" v-if="data.goodsData.hasGroup">去团购</el-button>
        </div>
        <div style="margin-top: 30px;" v-else>
          <el-button type="primary" plain style="padding: 20px 30px;">去购买</el-button>
        </div>
      </el-col>
    </el-row>
